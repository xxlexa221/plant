...
/* harmony import */ var _components_load__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/load */ "./src/js/components/load.js");
/* harmony import */ var _components_load__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_load__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _components_fslightbox__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_fslightbox__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _components_stopbg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/stopbg */ "./src/js/components/stopbg.js");
/* harmony import */ var _components_stopbg__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_components_stopbg__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _components_equipment__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/equipment */ "./src/js/components/equipment.js");
/* harmony import */ var _components_equipment__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_equipment__WEBPACK_IMPORTED_MODULE_5__);
...
let am = document.querySelector('.complect_info_1-1');
...
but1.addEventListener('click', () => {
  if (b.classList.contains('complects_info_active')) {
    ...
    bm.classList.toggle('complects_info_active');
...
const eq1 = document.querySelector('.list-item_1');
const eq2 = document.querySelector('.list-item_2');
const eq3 = document.querySelector('.list-item_3');
const eq4 = document.querySelector('.list-item_4');
const bl1 = document.querySelector('.complects_info-1');
const bl2 = document.querySelector('.complects_info-2');
const bl3 = document.querySelector('.complects_info-3');
const bl4 = document.querySelector('.complects_info-4');
const pl1 = document.querySelector('.image_list-1');
const pl2 = document.querySelector('.image_list-2');
const pl3 = document.querySelector('.image_list-3');
const pl4 = document.querySelector('.image_list-4');
eq1.addEventListener('click', () => {
  bl1.classList.toggle('complects_info-open-1');
  bl1.classList.toggle('complects_info-close');
  pl1.classList.toggle('image_rotate');
});
eq2.addEventListener('click', () => {
  bl2.classList.toggle('complects_info-open-2');
  bl2.classList.toggle('complects_info-close');
  pl2.classList.toggle('image_rotate');
});
eq3.addEventListener('click', () => {
  bl3.classList.toggle('complects_info-open-3');
  bl3.classList.toggle('complects_info-close');
  pl3.classList.toggle('image_rotate');
});
eq4.addEventListener('click', () => {
  bl4.classList.toggle('complects_info-open-4');
  bl4.classList.toggle('complects_info-close');
  pl4.classList.toggle('image_rotate');
});
...
function init() {
  let map = new ymaps.Map('map', {
    center: [47.211423576335584, 39.74355066637166],
    zoom: 17
  });
  let placemark = new ymaps.Placemark([47.211423576335584, 39.74355066637166], {}, {});
...
if (window <= '768') {
  swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.EffectCoverflow, swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay]);
